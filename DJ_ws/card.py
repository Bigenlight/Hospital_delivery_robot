...
class YOLOv7(Node):
    def __init__(self):
        ...
        self.detected_pub = self.create_publisher(Image, "/card_detected_image", 10)
        self.card_pub = self.create_publisher(String, "/card", 10)
    ...
    def yolo_pub(self):
        ...
        self.card_pub.publish(final_check)
